    ...
    const years = Array.from(
      new Set(
        activities.reduce((previous, activity) => {
          ...
          return Array.from(previous).concat(start, end);
          // return [
          //   ...previous,
          //   start,
          //   end
      ...
      <div
        ...
        <div className="gallery">
          ...
          <div
            ...
            {positionedActivities.map(({ body, image, name, moreLinks }, index) => {
              return (
                <div
                  ...
                  <div className="container">
                    ...
                    <div className="card">
                      <h5>{name}</h5>
                      <p>{body}</p>
                      {moreLinks && moreLinks.map((moreLink, i) => {
                        return <a className="external-link" href={moreLink.url} key={i}>{moreLink.text}</a>
                      })}
                    </div>
                  </div>
                </div>
